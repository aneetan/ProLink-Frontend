        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex space-x-3 pt-6">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-[var(--primary-color)] text-white px-4 py-2.5 rounded-md hover:bg-[var(--primary-dark)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {loading 
