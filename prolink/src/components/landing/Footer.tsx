  ...
  return (
        <footer className="bg-gray-100 dark:bg-gray-900 px-12">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-500 font-medium">
                            <li className="mb-4">
                                <a href="/companies" className="hover:underline"> View Companies</a>
                            </li>
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline"> ProLink </a>. All Rights Reserved.
                </span>
            </div>
            </div>
        </footer>
